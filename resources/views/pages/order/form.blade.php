                        ...
                        <div class="row" style="margin-top:20px;">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="nk-int-st" style="margin-bottom:20px;">
                                    ...
                                    <input type="text" class="form-control" placeholder="" id="order-number" disabled>
                                </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 divider-left">
                                ...
                                <div class="nk-datapk-ctm form-elet-mg" id="data_1" style="margin-bottom:20px;">
                                    ...
                                    <div class="input-group date nk-int-st">
                                        ...
                                        <input type="text" class="input-form form-control" name="order_date" value="{{date('m/d/Y')}}">
                                    </div>
                                </div>
                                <div class="bootstrap-select fm-cmp-mg" style="margin-bottom:20px;">
                                    <label>Branch:</label>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 divider-left">
                                ...
                                <div class="nk-int-st" style="margin-bottom:20px;">
                                    ...
                                    <input type="text" class="input-form form-control" placeholder="" name="deceased_name">
                                </div>
                                <div class="nk-datapk-ctm form-elet-mg" id="data_1" style="margin-bottom:20px;">
                                            ...
                                            <div class="widget-tabs-list">
                                                <ul class="nav nav-tabs">
                                                    ...
                                                    @foreach ($tabs as $key => $tab)
                                                        <li class="{{ $tab === Request::segment(3) ? 'active' : '' }} @if($key != 0) disabled @endif">
                                                            <a role="tab" href="{{ url('order/create/' . $tab) }}">
