        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                    <li class="active"><a data-toggle="tab" href="#orders"><i class="fa fa-list"></i> Orders</a></li>
                    <li><a data-toggle="tab" href="#schedules"><i class="fa fa-calendar"></i> Schedules</a></li>
                    <li><a data-toggle="tab" href="#reports"><i class="fa fa-folder-open-o"></i> Reports</a></li>
                    <li><a data-toggle="tab" href="#admin"><i class="fa fa-cog"></i> Admin</a></li>
                </ul>
                <div class="tab-content custom-menu-content">
                    <div id="orders" class="tab-pane notika-tab-menu-bg animated flipInX active">
                    ...
                    <div id="schedules" class="tab-pane notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
                            <li><a href="/new-memorial">New Memorial</a></li>
                            <li><a href="/renovation">Renovation</a></li>
                            <li><a href="/sundries">Sundries</a> </li>
